...
(cl:defmethod cl:initialize-instance :after ((m <Vector2D>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Vector2D)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ros_tengine-msg:<Vector2D> is deprecated: use ros_tengine-msg:Vector2D instead.")))

(cl:ensure-generic-function 'x-val :lambda-list '(m))
(cl:defmethod x-val ((m <Vector2D>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_tengine-msg:x-val is deprecated.  Use ros_tengine-msg:x instead.")
  (x m))

(cl:ensure-generic-function 'y-val :lambda-list '(m))
(cl:defmethod y-val ((m <Vector2D>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_tengine-msg:y-val is deprecated.  Use ros_tengine-msg:y instead.")
  (y m))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Vector2D>)))
  ...
  (cl:format cl:nil "# simple 2D vector~%float32 x~%float32 y~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Vector2D)))
  "Returns full string definition for message of type 'Vector2D"
  (cl:format cl:nil "# simple 2D vector~%float32 x~%float32 y~%~%~%"))

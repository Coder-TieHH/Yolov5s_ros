...
"""autogenerated by genpy from ros_tengine/Euler.msg. Do not edit."""
import codecs
import sys
...
class Euler(genpy.Message):
  _md5sum = "c66f4de7f99199dd8e863fffbef112ad"
  _type = "ros_tengine/Euler"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """# Euler angles
float32 roll
float32 pitch
float32 yaw
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(Euler, self).__init__(*args, **kwds)
